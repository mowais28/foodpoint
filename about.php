<?php
$page_url = 'about.php';
$page_heading = '<i class="fa fa-user text-white"></i>  About Us';
...
<body>
    ...
    if (file_exists(dirname(__FILE__) . "./components/about__content.php")) {
        include_once dirname(__FILE__) . "./components/about__content.php";
    }
